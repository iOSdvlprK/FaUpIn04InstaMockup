...
final class ProfileViewController: UIViewController {
    ...
    private let photoDataView = ProfileDataView(title: "posts", count: 123)
    private let followerDataView = ProfileDataView(title: "followers", count: 2_000)
    private let followingDataView = ProfileDataView(title: "following", count: 1)
...
private extension ProfileViewController {
    ...
    @objc func didTapRightBarButtonItem() {
        ...
        [
            UIAlertAction(title: "Change user's info", style: .default),
            UIAlertAction(title: "Unsubscribe", style: .destructive),
